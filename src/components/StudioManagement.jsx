...
function StudioManagement() {
    const { studioName, setStudioName, studioReputation } = useContext(GameContext);
    ...
    return (
        <div className="bg-kb-black p-4 rounded-lg shadow-md">
            ...
            >
                <h2 className="text-xl font-bold text-kb-white">Studio Management</h2>
                <svg 
            ...
            {isExpanded && (
                <>
                    <p className="text-kb-grey mt-2">Studio Name: {studioName}</p>
                    <p className="text-kb-grey">Reputation: {studioReputation.toFixed(2)}</p>
                    <div className="mt-4">
                        <input
                            type="text"
                            value={newStudioName}
